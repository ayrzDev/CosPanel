...
export default function MySQLWizardPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">MySQL Database Wizard</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Adım adım MySQL veritabanı oluşturun</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
        ...
        {step === 3 && (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Step 3: Assign Privileges</h3>
            <div className="grid grid-cols-2 gap-3">
              {['SELECT', 'INSERT', 'UPDATE', 'DELETE', 'CREATE', 'DROP', 'INDEX', 'ALTER'].map((priv) => (
                <label key={priv} className="flex items-center gap-2">
                  <input type="checkbox" defaultChecked className="rounded" />
                  <span className="text-sm text-gray-700 dark:text-gray-300">{priv}</span>
                </label>
              ))}
            </div>
            <div className="flex gap-3">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm text-green-800 dark:text-green-300">
                <p><strong>Database:</strong> {dbName || 'mydatabase'}</p>
                <p><strong>Username:</strong> {username || 'dbuser'}</p>
